...
void inicie_SPI(structspi* spi){
    ...
    spi -> estado_registro = 16;
    spi -> caso = 0;
    spi -> tamano_registro = 16;
}
...
void envie_dato(structspi* spi){
    ...
    {
        case 0:
            SPI1_WriteByte(spi -> canal);
            spi -> estado_registro = spi -> tamano_registro;
            spi -> estado_registro--;
            spi -> caso = 1;
            break;
        case 1:
            ...
            break;
        case 2:
            SPI1_WriteByte(spi-> ganancia);
            spi -> caso = 3;
            spi -> estado_registro--;
            break;
        case 3:
            SPI1_WriteByte(spi -> impedancia);
            spi -> caso = 4;
            spi -> estado_registro--;
        case 4:
            if(spi -> estado_registro){
                SPI1_WriteByte(((spi -> valor) >> (spi -> estado_registro)) & 0x01);
                spi -> estado_registro --;
            }
            else{
                spi -> valor_enviando = 0;
